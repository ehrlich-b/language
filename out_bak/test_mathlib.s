...
.str64:
    .ascii "operator\000"
.str65:
    .ascii "TOK_PLUS || tok_kind(t) == TOK_MINUS || tok_kind(t) == TOK_STAR || tok_kind(t) == TOK_SLASH || tok_kind(t) == TOK_PERCENT || tok_kind(t) == TOK_LT || tok_kind(t) == TOK_GT || tok_kind(t) == TOK_EQ\000"
.str66:
    .ascii " {\000"
.str67:
...
.str199:
    .ascii ";\012\000"
.str200:
    .ascii "=== Testing Lisp-defined math library ===\000"
.str201:
    .ascii "\000"
.str202:
    .ascii "abs(-42) = \000"
...
.str206:
    .ascii "\000"
.str207:
    .ascii "clamp(5, 0, 10) = \000"
.str208:
    .ascii ", clamp(-5, 0, 10) = \000"
.str209:
    .ascii ", clamp(15, 0, 10) = \000"
.str210:
    .ascii "\000"
.str211:
    .ascii "factorial(6) = \000"
.str212:
    .ascii "\000"
.str213:
    .ascii "fib(10) = \000"
...
.str222:
    .ascii "Lisp -> Lang interop works perfectly!\000"
heap_pos:
    .quad 0
heap_end:
    .quad 0
