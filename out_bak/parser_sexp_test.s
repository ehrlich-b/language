...
.str125:
    .ascii "42\000"
.str126:
    .ascii "FAIL: could not parse number\012\000"
.str127:
    .ascii "FAIL: expected number kind (1), got \000"
.str128:
    .ascii "\012\000"
.str129:
    .ascii "foo\000"
.str130:
    .ascii "FAIL: could not parse symbol\012\000"
.str131:
    .ascii "FAIL: expected symbol kind (2), got \000"
.str132:
    .ascii "\012\000"
.str133:
    .ascii "()\000"
.str134:
    .ascii "FAIL: could not parse empty list\012\000"
.str135:
    .ascii "FAIL: expected list kind (4), got \000"
.str136:
    .ascii "\012\000"
.str137:
    .ascii "(add 1 2)\000"
.str138:
    .ascii "FAIL: could not parse (add 1 2)\012\000"
.str139:
    .ascii "FAIL: expected 3 children in inner list, got \000"
.str140:
    .ascii "\012\000"
.str141:
    .ascii "(a (b c) d)\000"
.str142:
    .ascii "FAIL: could not parse nested list\012\000"
.str143:
    .ascii "FAIL: expected 3 children in nested inner list, got \000"
.str144:
    .ascii "\012\000"
.str145:
    .ascii "PASS: parser_sexp_test - all s-expression tests passed\012\000"
heap_pos:
    .quad 0
heap_end:
    .quad 0
